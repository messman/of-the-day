...
import { PostResponse, Post } from 'oftheday-shared';
...
export async function getPosts(sheetsService: SheetsService, includeTomorrow: boolean, dayNumber: number, daysToReturn: number): Promise<PostResponse> {
	try {
